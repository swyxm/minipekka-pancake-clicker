...
<div align="center">
![Pancake Clicker Banner](/pekkalogo.png)
...
|-----------|--------|-------------|-----------------|
| ![Mini Pekka](./public/minipekka.png) **Mini Pekka** | 🟡 Starter | Your loyal pancake-making companion | 1 |
| ![Knight](./public/knight.png) **Knight** | ⚪ Common | A brave knight who loves pancake duty | 2 |
| ![Wizard](./public/wizard.png) **Wizard** | 🔵 Rare | A magical wizard who conjures pancakes | 5 |
| ![Baby Dragon](./public/bbdragon.png) **Baby Dragon** | 🟣 Epic | A cute dragon who breathes pancake fire | 15 |
| ![Prince](./public/prince.png) **Prince** | 🟠 Legendary | A royal prince who commands pancake armies | 50 |
| ![P.E.K.K.A](./public/pekka.png) **P.E.K.K.A** | 🔴 Champion | The ultimate pancake making machine | 200 |
...
|---------|------|-------------|-------------------|
| **Mini Sword** | ![Mini Sword](./public/minisword.png) | Sharp blade for better clicking | +1 per level |
| **Royal Reinforcement** | ![Royal Reinforcement](./public/royalreinforcement.png) | Elite training for maximum efficiency | +2 per level |
| **Elixir Overclock** | ![Elixir](./public/elixir.png) | Magical elixir boosts your power | +5 per level |
| **Rage Spell** | ![Rage](./public/rage.png) | Berserker rage for explosive clicks | +10 per level |
| **P.E.K.K.A Core** | ![P.E.K.K.A Core](./public/pekkacore.png) | The ultimate power source | +25 per level |
...
| ![Framer Motion](https://img.shields.io/badge/Framer_Motion-12.23.12-0055FF?style=flat-square) | 12.23.12 | Smooth animations and transitions |
| ![Zustand](https://img.shields.io/badge/Zustand-5.0.8-FF6B6B?style=flat-square) | 5.0.8 | Lightweight state management |
| ![Lucide React](https://img.shields.io/badge/Lucide_React-0.543.0-FF6B6B?style=flat-square) | 0.543.0 | Beautiful icons |
